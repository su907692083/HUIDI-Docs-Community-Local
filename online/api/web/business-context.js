...
function loadDocumentEntryConnectivity(){if(window.HUIDIDocumentEntryConnectivity)return;loadScript('data-huidi-document-entry-connectivity','/assets/document-entry-connectivity-v1.js?v=HUIDI-DOCUMENT-ENTRY-1',()=>window.HUIDIDocumentEntryConnectivity?.refresh?.())}
