...
def _workspace_html() -> str:
    ...
    # Business Activity Timeline projects existing development/mail/deal/document
    ...
    if "huidi-community-online-nav-v1.js" not in html:
        body_assets = (
            ...
            f'<script src="/community/huidi-mail-setup-refinement-v1.js?v={FUSION_ASSET_VERSION}"></script>'
            f'<script src="/community/huidi-mail-setup-modal-compat-v1.js?v={FUSION_ASSET_VERSION}"></script>'
        )
        if "</body>" not in html:
