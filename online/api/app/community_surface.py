...
def _workspace_html() -> str:
    ...
    # loaded after the capability tabs. A final scoped routing bridge connects
    # potential-customer / follow-up / reply rows into that same workbench and
    # never observes document.body or creates another business owner.
