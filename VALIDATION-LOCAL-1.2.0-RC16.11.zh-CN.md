...
Acceptance conditions per case: pagination report valid, overflowPages empty, semanticViolations empty, rendered product-row count equals source product-row count, real DOM clipping detector = 0, `fpPaginationStable = 1`.
...
Keep RC16.11 on release/test branch until real Windows acceptance passes.
