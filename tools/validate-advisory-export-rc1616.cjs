...
need(pkg.version==='1.2.0-rc16.16','package identity');need(manifest.version==='1.2.0-RC16.16'&&manifest.release==='RC16.16','manifest identity');
...
if(fail.length){console.error('RC16.16 VALIDATION FAILED');fail.forEach(x=>console.error('-',x));process.exit(1)}console.log('RC16.16 ADVISORY EXPORT + RESPONSIVE PIPELINE VALIDATION PASSED');
