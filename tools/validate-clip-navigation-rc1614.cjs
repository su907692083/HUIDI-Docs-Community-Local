...
const nav=read('public/huidi-issue-navigator-rc1614.js');
...
need(editor.includes('huidi-issue-navigator-rc1614.js'),'RC16.14 navigator loaded by editor');
need(editor.indexOf('huidi-issue-navigator-rc1614.js')<editor.indexOf('flypigbox-v3-3-6-24-r1-3a-18-formal-output-gate.js'),'navigator loads before formal output gate');
