/* HUIDI Docs Community Local RC16.21 — Single Toolbar Owner + interaction-safe geometry. */
(()=>{
  'use strict';
  const VERSION='HUIDI-DOCS-COMMUNITY-LOCAL-1.2.0-RC16.21-TOOLBAR-OWNER';
  const ORDER=[
  ...
  function reconcile(){
    ...
    try{
      ...
      actions.dataset.huidiToolbarOwner='rc1617'; /* compatibility with legacy shell guard */
